        ...
        <div>
          <div className="border-[2px] border-[solid] border-[grey] rounded-md py-4 px-3">
            ...
            <div className="sm:text-[40px] text-[30px]">
              {scorePercent < 56 ? (
                <h1 className="">ВАШ РЕЗУЛЬТАТ НЕ ХОРОШИЙ!!</h1>
              ) : (
                <h1> </h1>
              )}
              {scorePercent > 55 && scorePercent < 71 ? (
                <h1 className="">у тебя как минимум 3</h1>
              ) : (
                <h1> </h1>
              )}
              {scorePercent > 70 && scorePercent < 86 ? (
                <h1 className="">Вы получили Маладес 4</h1>
              ) : (
                <h1> </h1>
              )}
              {scorePercent > 85 ? (
                <h1 className="">ПОМНИТЕ, ЭТОТ РЕБЕНОК ПОЛУЧИЛ 5</h1>
              ) : (
                <h1> </h1>
              )}
            </div>
