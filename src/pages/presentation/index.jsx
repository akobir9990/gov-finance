  ...
  const items = [
    {
      ...
      url: "1",
      themeName:
        "«ВВЕДЕНИЕ В ДИСЦИПЛИНУ ГОСУДАРСТВЕННЫЕ ФИНАНСЫ. СОДЕРЖАНИЕ И СУЩНОСТЬ ГОСУДАРСТВЕННЫХ ФИНАНСОВ»",
    },
    {
      id: 2,
      path: "",
      url: "2",
      themeName: "«ТЕОРИИ О ГОСУДАРСТВЕННЫХ ФИНАНСАХ»",
    },
    {
      id: 3,
      path: "",
    ...
    },
    {
      ...
      path: "",
      url: "7",
      themeName: "«ГОСУДАРСТВЕННЫЕ ЦЕЛЕВЫЕ И ВНЕБЮДЖЕТНЫЕ ФОНДЫ»",
    },
    {
      id: 8,
      path: "",
    ...
    },
    {
      ...
      url: "15",
      themeName:
        "«ОСНОВНЫЕ НАПРАВЛЕНИЯ РЕФОРМ СИСТЕМЫ ГОСУДАРСТВЕННЫХ ФИНАНСОВ В РЕСПУБЛИКИ УЗБЕКИСТАН» ",
    },
  ];
  return (
